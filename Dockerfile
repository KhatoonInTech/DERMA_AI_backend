...
CMD sh -c "echo -e \"$GOOGLE_APPLICATION_CREDENTIALS\" > $CREDENTIALS_PATH && export GOOGLE_APPLICATION_CREDENTIALS=$CREDENTIALS_PATH && uvicorn app:app --host 0.0.0.0 --port $PORT"
